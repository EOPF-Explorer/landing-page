...
export const servicesContent = [
  ...
  },
  {
    ...
    tags: ["<i class='mdi mdi-map-search'></i> screening", "arithmetic", "expressions", "band-math"],
    category: "Screening",
    type: "software",
    link: "./titiler",
    contain: true,
  ...
  },
  {
    ...
    tags: ["<i class='mdi mdi-map-search'></i> screening", "web-mapping", "visualization", "geozarr"],
    category: "Screening",
    type: "software",
    link: "./ol",
    contain: true,
  ...
  },
  {
    ...
    tags: ["<i class='mdi mdi-chart-box'></i> screening", "dashboard", "web-components", "geozarr"],
    category: "Screening",
    type: "software",
    link: "./eodash",
    contain: true,
  ...
  },
  {
    ...
    tags: ["<i class='mdi mdi-map-search'></i> screening", "experimental", "web-mapping", "WebGL", "geozarr"],
    category: "Screening",
    type: "software",
