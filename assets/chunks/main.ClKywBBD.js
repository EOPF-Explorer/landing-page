 ...
 */const ge=e=>e??yt;var ot,De,Ve;class $i extends lt{constructor(){super();A(this,ot,[]);A(this,De,ho`
  ...
  `);A(this,Ve,"");this.unstyled=!1,this.noShadow=!1,this.layer=null}get layerLegend(){return x(this,ot)?x(this,ot).length>1?x(this,ot):x(this,ot)[0]:null}set layerLegend(o){var i;o?Array.isArray(o)?ut(this,ot,o.map((r,n)=>{var a;return{id:(((a=this.layer)==null?void 0:a.get("id"))??"")+n,...r}})):ut(this,ot,[{id:(((i=this.layer)==null?void 0:i.get("id"))??"")+0,...o}]):ut(this,ot,null)}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}firstUpdated(){this.layerLegend&&new ResizeObserver(()=>{var o;ut(this,ot,(o=x(this,ot))==null?void 0:o.map(i=>(this.offsetWidth!==i.width&&(i.width=this.offsetWidth),{...i}))),this.requestUpdate()}).observe(this.renderRoot.querySelector(".legend-container"))}render(){return customElements.get("color-legend")||console.error("Please import `color-legend-element` in order to use layerLegend"),h`
      ...
      ${V(this.layerLegend,()=>h`
        ...
        `)}
    `}}ot=new WeakMap,De=new WeakMap,Ve=new WeakMap,R($i,"properties",{unstyled:{type:Boolean},noShadow:{type:Boolean},layerLegend:{attribute:!1},layer:{attribute:!1}});customElements.define("eox-layercontrol-layer-legend",$i);var pt,kt,ie,re,vo,Le,Ie;class Ci extends lt{constructor(){super();A(this,re);A(this,pt,{});A(this,kt,null);A(this,ie);A(this,Le,ho`
    color-legend {
      --cle-background: transparent;
      --cle-font-family: inherit;
      --cle-font-size: 12px;
      ...
      <div class="${this.toolsAsList?"listed":"tabbed"}">
        ...
        >
          ...
          ${ye(o,(n,a)=>h`
              ...
              ${V(this.toolsAsList&&a<o.length-1,()=>h`<hr class="small" />`)}
            `)}
        </figure>
      </div>
    `}}ne=new WeakMap,Oe=new WeakMap,Me=new WeakMap,R(_i,"properties",{actions:{attribute:!1},selectedTab:{state:!0},tabs:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean},toolsAsList:{type:Boolean}});customElements.define("eox-layercontrol-tools-items",_i);var Be,Vi,Ne,ke;class Di extends lt{constructor(){super();A(this,Be);R(this,"_removeButton",o=>vi(this,o));R(this,"_sortButton",o=>bi(this,o,this.unstyled));R(this,"_button",(o,i)=>Bn(o,i,this.unstyled));R(this,"_getDefaultTools",o=>{var i,r;return h`
      ...
      <div slot="config-content">
        ...
        ${V(this.layer.get("layerConfig"),()=>h`
            <eox-layercontrol-layerconfig
              ...
              @layerConfig:change=${L(this,Be,Vi)}
            ></eox-layercontrol-layerconfig>
          `)}
      </div>
  ...
  `);this.layer=null,this.layerType=void 0,this.map=null,this.titleProperty="title",this.showLayerZoomState=!1,this.tools=[],this.unstyled=!1,this.noShadow=!1,this.toolsAsList=!1,this.globallyExclusiveLayers=!1,this.customEditorInterfaces=[]}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}firstUpdated(){ia(this)}render(){var f,d;const o=this.layer.getVisible(),i=o?"visible":"",r=this.currLayerVisibilityBasedOnZoom?"":"zoom-state-invisible",n=L(this,ct,Ot).call(this,"layerControlDisable")?"disabled":"",a=L(this,ct,Ot).call(this,"layerControlExclusive")?"radio":"checkbox",s=((f=yi(this.tools,this.layer))==null?void 0:f.length)>0,l=((d=mi(this.tools,this.layer))==null?void 0:d.length)>0,u=document.querySelector("eox-layercontrol-layer-tools");return u&&Object.assign(u,{layer:this.layer,tools:this.tools,toolsAsList:this.toolsAsList}),h`
      ...
      ${V(this.layer,()=>h`
          ...
          >
            ${V(!this.unstyled,()=>{if(L(this,ct,Ot).call(this,"color"))return h`
                  <i class="small" style="color: ${L(this,ct,Ot).call(this,"color")}">
            ...
            <div class="max truncate drag-handle ${n}">
              <span class="layertitle truncate"
                >${L(this,ct,Ot).call(this,this.titleProperty)}</span
              >
            </div>
            ...
            ${V(l,()=>h`
                <button
                  ...
                  @click=${()=>{var m,g,w;const y=((g=(m=this.renderRoot.querySelector("eox-layercontrol-layer-tools"))==null?void 0:m.shadowRoot)==null?void 0:g.querySelector("details"))||((w=this.renderRoot.querySelector("eox-layercontrol-layer-tools"))==null?void 0:w.querySelector("details"));y.open=!y.open}}
                >
                  <i class="small">
              ...
              `)}
            ${V(!l&&s,()=>this.tools[0]==="remove"?vi(this,ee()[this.tools[0]]):bi(this,ee()[this.tools[0]],!1))}
      ...
      ${V(l&&!u,()=>h`
          ...
          ></eox-layercontrol-layer-tools>
        `)}
    `}}ct=new WeakSet,Ot=function(o){var i;return(i=this.layer)==null?void 0:i.get(o)},Ii=function(o){ra(o,this)},Ue=new WeakMap,Fe=new WeakMap,R(Li,"properties",{layer:{attribute:!1},layerType:{attribute:!1},map:{attribute:!1,state:!0},titleProperty:{attribute:"title-property",type:String},showLayerZoomState:{attribute:"show-layer-zoom-state",type:Boolean},tools:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean},toolsAsList:{type:Boolean},globallyExclusiveLayers:{type:Boolean},customEditorInterfaces:{attribute:!1,type:Array}});customElements.define("eox-layercontrol-layer",Li);var qe,je;class Ri extends lt{constructor(){super();A(this,qe,"");A(this,je,`
    details > summary {
      min-block-size: 0rem;
  ...
  `);this.group=null,this.idProperty="id",this.map=null,this.titleProperty="title",this.showLayerZoomState=!1,this.tools=[],this.unstyled=!1,this.noShadow=!1,this.toolsAsList=!1,this.globallyExclusiveLayers=!1,this.customEditorInterfaces=[]}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){var r,n;const o=!!((r=this.group)!=null&&r.get("layerControlExpand")),i=(n=wi(this.group.getLayers()))==null?void 0:n.length;return h`
      ...
      ${V(this.group,()=>h`
        ...
        `)}
    `}}qe=new WeakMap,je=new WeakMap,R(Ri,"properties",{group:{attribute:!1},idProperty:{attribute:"id-property"},map:{attribute:!1,state:!0},titleProperty:{attribute:"title-property",type:String},showLayerZoomState:{attribute:"show-layer-zoom-state",type:Boolean},tools:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean},toolsAsList:{type:Boolean},globallyExclusiveLayers:{type:Boolean},customEditorInterfaces:{attribute:!1,type:Array}});customElements.define("eox-layercontrol-layer-group",Ri);const na=e=>{const{layers:t,idProperty:o,titleProperty:i,renderRoot:r}=e,n=ir(()=>{e.requestUpdate(),e.dispatchEvent(new CustomEvent("changed",{bubbles:!0}))},50),a=()=>n();if(t&&(t.hasListener("change:length")&&(t==null||t.un("change:length",a)),t.on("change:length",a),t)){const s=r.querySelector("ul");Ln(t,o,i,e),Vn(s,t,o,e)}};var Ze,Xe;class Pi extends lt{constructor(){super();A(this,Ze,"");A(this,Xe,`
  ...
  `);this.for="eox-map",this.idProperty="id",this.map=null,this.titleProperty="title",this.showLayerZoomState=!1,this.tools=["info","opacity","datetime","config","remove","sort"],this.addExternalLayers=!1,this.unstyled=!1,this.styleOverride="",this.toolsAsList=!1,this.globallyExclusiveLayers=!1,this.customEditorInterfaces=[]}firstUpdated(){this.eoxMap=Zo(this)}updated(o){o.has("for")&&(this.eoxMap=Zo(this))}get eoxMap(){return x(this,Ct)}set eoxMap(o){const i=x(this,Ct);ut(this,Ct,o),this.requestUpdate("eoxMap",i)}render(){var r,n,a;const o=(r=this.map)==null?void 0:r.getLayers().getArray(),i=o&&((n=To(o,"layerControlOptional",!0))==null?void 0:n.length)>0;return h`
      ...
      ${V(this.addExternalLayers&&((a=x(this,Ct))==null?void 0:a.addOrUpdateLayer),()=>h`
      ...
      ${V(this.map,()=>h`
          <eox-layercontrol-layer-list
            ...
            @layerConfig:change=${L(this,Ft,ji)}
          ></eox-layercontrol-layer-list>
        `)}
