...
var nt=Object.defineProperty;var rt=(n,t,e)=>t in n?nt(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var v=(n,t,e)=>rt(n,typeof t!="symbol"?t+"":t,e);import{aD as N,a1 as z,o as C,c as j,K as at,k as F,j as ot,t as lt,e as L,b as ct,h as M,p as ht}from"./framework.-zR_n9c0.js";import{f as dt,u as ut,E as ft,b as E,w as _,i as pt,a as mt}from"./lit-element.CBn2YVps.js";import{s as gt,l as O,i as I,a as yt,b as W,q as bt,t as kt,o as wt,p as vt,f as xt}from"./sequential.BdGG0OD6.js";import{e as _t,i as Tt,t as Ct}from"./directive.CvdRHFdJ.js";import"./main.DLDLS8XS.js";import{_ as Et,ag as St,u as At,am as jt,al as Ft,aN as U,aO as q,bv as Lt,bi as Dt,bh as Ot,bw as It}from"./eo-dash.E0tu4tOA.js";import $t from"./EodashLayoutSwitcher-BV60y5OI.ClgaXOex.js";import{e as Vt}from"./mdi.XrkXf12J.js";import"./addCommonStyleSheet.ChJ9KvO8.js";import"./dayjs.min.Ba62AOpW.js";import"./commonjsHelpers.BosuxZz1.js";import"./when.BR7zwNJC.js";import"./map.DiiNQ3pp.js";import"./toolcool-range-slider.min.BBXDELo7.js";import"./getElement.CdRlZPdn.js";import"./index.BIJR-IiI.js";import"./migrate.DkSLOl0d.js";import"./VTooltip-CeVb1ATW.CyMklN2S.js";import"./forwardRefs-DcXKtmaD.DZxvwzuV.js";import"./transition-rURoF50S.B_pYre-0.js";/**
 * @license
 ...
 */const D=_t(class extends Tt{constructor(n){var t;if(super(n),n.type!==Ct.ATTRIBUTE||n.name!=="class"||((t=n.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(n){return" "+Object.keys(n).filter(t=>n[t]).join(" ")+" "}update(n,[t]){var i,r;if(this.st===void 0){this.st=new Set,n.strings!==void 0&&(this.nt=new Set(n.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in t)t[s]&&!((i=this.nt)!=null&&i.has(s))&&this.st.add(s);return this.render(t)}const e=n.element.classList;for(const s of this.st)s in t||(e.remove(s),this.st.delete(s));for(const s in t){const a=!!t[s];a===this.st.has(s)||(r=this.nt)!=null&&r.has(s)||(a?(e.add(s),this.st.add(s)):(e.remove(s),this.st.delete(s)))}return ft}});class Ut{constructor(t){this.cle=t}render(){const t=this.cle.titleText?E`<p class="legend-title">${this.cle.titleText}</p>`:"",e={hidden:this.cle.scaleType==="categorical"},i={hidden:this.cle.scaleType!=="categorical","categorical-container":!0};return E`<div
    ...
    >
      ...
      <slot name="footer"></slot>
        ...
        >
          ${s}
        </li>`)}`}renderContinuous(){var h;if(this.cle.scaleType!=="continuous"&&this.cle.scaleType!=="log10"||this.cle.colorScale===null)return"";const{colorScale:t,marginTop:e,marginLeft:i,marginRight:r,tickSize:s,width:a,range:o}=this.cle,c=this.cle.marginBottom+s,d=this.cle.height+s,l=((h=t.interpolator)==null?void 0:h.call(t))||vt(I,o);return _`<image
      x=${i}
      y=${e}
      width=${a-r-i}
      height=${d-e-c}
