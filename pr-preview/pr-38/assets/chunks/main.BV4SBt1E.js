 ...
 */const ge=e=>e??yt;var it,Le,Ve;class $o extends lt{constructor(){super();A(this,it,[]);A(this,Le,hi`
  ...
  `);this.layer=null,this.unstyled=!1,this.noShadow=!1,this.layerConfig=null,this.throttleDataChange=Fi(I(this,ne,mi),1e3),this.customEditorInterfaces=[]}updated(i){if(i.has("layerConfig")){const o=this.layerConfig.type==="style"||this.layerConfig.style?100:1e3;this.throttleDataChange=Fi(I(this,ne,mi),o),this.requestUpdate()}}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){ut(this,kt,Pr(this.layer,this.layerConfig)),Object.keys(x(this,pt)).length!==0&&ut(this,kt,x(this,pt)),customElements.get("eox-jsonform")||console.error("Please import @eox/jsonform in order to use layerconfig");const i={disable_edit_json:!0,disable_collapse:!0,disable_properties:!0};return h`
      ...
      ${L(this.layerConfig,()=>h`
          ...
          ></eox-jsonform>
        `)}
    `}}pt=new WeakMap,kt=new WeakMap,oe=new WeakMap,ne=new WeakSet,mi=function(i){ut(this,pt,i.detail),this.layerConfig.type==="style"||this.layerConfig.style?"setStyle"in this.layer||"updateStyleVariables"in this.layer?Ir(x(this,pt),this.layer,this.layerConfig):console.error(`Layer type ${this.layer.get("type")??""} does not support styles configuration`):ut(this,oe,Vr(x(this,pt),x(this,oe),this)),this.dispatchEvent(new CustomEvent("layerConfig:change",{bubbles:!0,detail:{jsonformValue:i.detail,layer:this.layer}})),this.requestUpdate()},Ie=new WeakMap,Re=new WeakMap,H(Co,"properties",{layer:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean},layerConfig:{attribute:!1},customEditorInterfaces:{attribute:!1,type:Array}});customElements.define("eox-layercontrol-layerconfig",Co);var He,To,Pe,Oe;class Ao extends lt{constructor(){super();A(this,He);A(this,Pe,"");A(this,Oe,"");this.unstyled=!1,this.noShadow=!1,this.layerDatetime=null,this.layer=null}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){return customElements.get("eox-timecontrol")||console.error("Please import @eox/timecontrol in order to use layerDatetime"),h`
      <style>
        ${x(this,Pe)}
      ...
      ${L(this.layerDatetime,()=>h`
        ...
        `)}
    `}}He=new WeakSet,To=function(i){var a;const o=new Date(i.detail.date[0]),n=(a=this.layerDatetime.controlValues)==null?void 0:a.some(s=>typeof s=="string"&&s.includes("T"));let r;n?r=o.toISOString():r=(l=>`${l.getFullYear()}-${String(l.getMonth()+1).padStart(2,"0")}-${String(l.getDate()).padStart(2,"0")}`)(o),r!==this.layerDatetime.currentStep&&(this.dispatchEvent(new CustomEvent("datetime:updated",{bubbles:!0,detail:{datetime:r,layer:this.layer}})),this.layerDatetime.currentStep=r,this.requestUpdate())},Pe=new WeakMap,Oe=new WeakMap,H(Ao,"properties",{unstyled:{type:Boolean},noShadow:{type:Boolean},layerDatetime:{attribute:!1},layer:{attribute:!1}});customElements.define("eox-layercontrol-layer-datetime",Ao);var re,Me,Be;class _o extends lt{constructor(){super();A(this,re,i=>(this.selectedTab===i||this.toolsAsList)&&"highlighted");A(this,Me,`
    .tabbed figure,
    .listed figure {
      margin: 0;
    }
  ...
  `);this.actions=[],this.selectedTab=0,this.tabs=[],this.unstyled=!1,this.noShadow=!1,this.toolsAsList=!1}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){const i=this.tabs,o=this.actions,n=o.length+i.length>1;return h`
    ...
    `}}re=new WeakMap,Me=new WeakMap,Be=new WeakMap,H(_o,"properties",{actions:{attribute:!1},selectedTab:{state:!0},tabs:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean},toolsAsList:{type:Boolean}});customElements.define("eox-layercontrol-tools-items",_o);var Ne,Lo,ke,Ue;class Do extends lt{constructor(){super();A(this,Ne);H(this,"_removeButton",i=>vo(this,i));H(this,"_sortButton",i=>bo(this,i,this.unstyled));H(this,"_button",(i,o)=>Or(i,o,this.unstyled));H(this,"_getDefaultTools",i=>{var o,n;return h`
      ...
      <div slot="config-content">
        ...
        ${L(this.layer.get("layerConfig"),()=>h`
            <eox-layercontrol-layerconfig
              ...
              @layerConfig:change=${I(this,Ne,Lo)}
            ></eox-layercontrol-layerconfig>
          `)}
      </div>
  ...
  `);this.group=null,this.idProperty="id",this.map=null,this.titleProperty="title",this.showLayerZoomState=!1,this.tools=[],this.unstyled=!1,this.noShadow=!1,this.toolsAsList=!1,this.globallyExclusiveLayers=!1,this.customEditorInterfaces=[]}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){var n,r;const i=!!((n=this.group)!=null&&n.get("layerControlExpand")),o=(r=wo(this.group.getLayers()))==null?void 0:r.length;return h`
      ...
      ${L(this.group,()=>h`
        ...
        `)}
    `}}Ze=new WeakMap,Xe=new WeakMap,H(Ro,"properties",{group:{attribute:!1},idProperty:{attribute:"id-property"},map:{attribute:!1,state:!0},titleProperty:{attribute:"title-property",type:String},showLayerZoomState:{attribute:"show-layer-zoom-state",type:Boolean},tools:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean},toolsAsList:{type:Boolean},globallyExclusiveLayers:{type:Boolean},customEditorInterfaces:{attribute:!1,type:Array}});customElements.define("eox-layercontrol-layer-group",Ro);const oa=e=>{const{layers:t,idProperty:i,titleProperty:o,renderRoot:n}=e,r=nn(()=>{e.requestUpdate(),e.dispatchEvent(new CustomEvent("changed",{bubbles:!0}))},50),a=()=>r();if(t&&(t.hasListener("change:length")&&(t==null||t.un("change:length",a)),t.on("change:length",a),t)){const s=n.querySelector("ul");Dr(t,i,o,e),_r(s,t,i,e)}};var je,Ye;class Ho extends lt{constructor(){super();A(this,je,"");A(this,Ye,`
  ...
  `);this.idProperty="id",this.layers=null,this.map=null,this.tools=void 0,this.titleProperty="title",this.showLayerZoomState=!1,this.unstyled=!1,this.noShadow=!1,this.toolsAsList=!1,this.globallyExclusiveLayers=!1,this.customEditorInterfaces=[]}firstUpdated(){oa(this)}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){const i=this.layers?wo(this.layers).reverse():[];return h`
    ...
    `}}je=new WeakMap,Ye=new WeakMap,H(Ho,"properties",{idProperty:{attribute:"id-property"},layers:{attribute:!1},map:{attribute:!1,state:!0},titleProperty:{attribute:"title-property",type:String},showLayerZoomState:{attribute:"show-layer-zoom-state",type:Boolean},tools:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean},toolsAsList:{type:Boolean},globallyExclusiveLayers:{type:Boolean},customEditorInterfaces:{attribute:!1,type:Array}});customElements.define("eox-layercontrol-layer-list",Ho);const na=e=>{const t=e.querySelector("select[name=optional]"),i=t?t.value:null,o=Ai(e.layers.getArray(),"layerControlOptional",!0).find(n=>(n.get(e.idProperty)||n.ol_uid)===i);o==null||o.set("layerControlOptional",!1),o==null||o.setVisible(!0),e.dispatchEvent(new CustomEvent("changed",{bubbles:!0})),e.renderRoot.parentNode.querySelectorAll("eox-layercontrol-layer-list").forEach(n=>n.requestUpdate()),e.requestUpdate()};var ze,Oo;class Po extends lt{constructor(){super();A(this,ze);this.idProperty="id",this.layers=null,this.titleProperty="title",this.unstyled=!1,this.noShadow=!1}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){const i=Ai(this.layers.getArray(),"layerControlOptional",!0);return h`
      <nav class="bottom-padding large-padding">
        ...
        <button class="small" @click="${I(this,ze,Oo)}">Add</button>
      </nav>
    `}}ze=new WeakSet,Oo=function(){na(this)},H(Po,"properties",{idProperty:{attribute:"id-property"},layers:{attribute:!1},titleProperty:{attribute:"title-property",type:String},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-optional-list",Po);const ra=(e,t)=>{t.jsonInput=e.target.value,t.requestUpdate()},qi=e=>{const t=JSON.parse(`{"data":${Ki(e.jsonInput)}}`);Array.isArray(t.data)?t.data.forEach(i=>{e.eoxMap.addOrUpdateLayer(i)}):e.eoxMap.addOrUpdateLayer(t.data),e.jsonInput=null,e.requestUpdate()},aa=(e,t)=>{t.urlInput=e.target.value,t.requestUpdate()};async function sa(e){const t=e.urlInput;if(e.wmsCapabilities=null,e.searchLoad=!0,e.requestUpdate(),!t)return!1;if(Si(t)==="XYZ")return{Name:t};try{const i=await Jn(t);e.wmsCapabilities=i}catch{}finally{e.searchLoad=!1,e.requestUpdate()}return!1}const la=(e,t)=>{const{Name:i}=e,o=Si(t.urlInput)||"XYZ",n={type:"Tile",properties:{id:i,title:i},source:{type:o,url:t.urlInput,params:{LAYERS:i}}};t.jsonInput=JSON.stringify(n)},ua=(e,t)=>{t.open=e||null,t.urlInput=null,t.jsonInput=null,t.wmsCapabilities=null,t.requestUpdate()};var U,Bo,No,vi,ko,Uo,xe,We;class Mo extends lt{constructor(){super();A(this,U);H(this,"urlInput",null);H(this,"jsonInput",null);H(this,"open",null);H(this,"searchLoad",!1);H(this,"wmsCapabilities",null);A(this,We,`
  ...
  `);this.eoxMap=null,this.unstyled=!1,this.noShadow=!1}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){const i={add:h`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <div class="eox-add-layer-main">
        <nav class="eox-add-layer-col">
          ...
          >
            <a
              @click=${()=>I(this,U,xe).call(this,"url")}
              class="${n?"active":""}"
            >
              URL
            </a>
            <a
              @click=${()=>I(this,U,xe).call(this,"json")}
              class="${r?"active":""}"
            >
              JSON
            </a>
          ...
          <button
            ...
            @click=${()=>I(this,U,xe).call(this,this.open?null:"url")}
          >
    ...
    `}}U=new WeakSet,Bo=function(i){aa(i,this)},No=async function(){const i=await sa(this);i&&I(this,U,vi).call(this,i)},vi=function(i){la(i,this),qi(this)},ko=function(){qi(this)},Uo=function(i){ra(i,this)},xe=function(i){ua(i,this)},We=new WeakMap,H(Mo,"properties",{eoxMap:{attribute:!1,state:!0},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-add-layers",Mo);const ca=(e,t)=>{if(t.requestUpdate(),e.target.tagName==="EOX-LAYERCONTROL-LAYER-TOOLS"){const i=t.renderRoot.querySelector("eox-layercontrol-optional-list");i==null||i.requestUpdate()}},Zi=e=>{const t=rn(e.for);return t&&t.map!==e.map&&(e.map=t.map),t};Wo();var Ct,Ft,qo,Zo,Ge;class Fo extends lt{constructor(){super();A(this,Ft);A(this,Ct);A(this,Ge,`
    ${bi}
    :host, :root {
      --padding: 0.5rem;
  ...
  `);this.for="eox-map",this.idProperty="id",this.map=null,this.titleProperty="title",this.showLayerZoomState=!1,this.tools=["info","opacity","datetime","config","remove","sort"],this.addExternalLayers=!1,this.unstyled=!1,this.styleOverride="",this.toolsAsList=!1,this.globallyExclusiveLayers=!1,this.customEditorInterfaces=[]}firstUpdated(){this.eoxMap=Zi(this)}updated(i){i.has("for")&&(this.eoxMap=Zi(this))}get eoxMap(){return x(this,Ct)}set eoxMap(i){const o=x(this,Ct);ut(this,Ct,i),this.requestUpdate("eoxMap",o)}render(){var n,r,a;const i=(n=this.map)==null?void 0:n.getLayers().getArray(),o=i&&((r=Ai(i,"layerControlOptional",!0))==null?void 0:r.length)>0;return h`
      <style>
      ...
      ${L(this.map,()=>h`
          <eox-layercontrol-layer-list
            ...
            .globallyExclusiveLayers=${this.globallyExclusiveLayers}
            .customEditorInterfaces=${this.customEditorInterfaces}
            @changed=${I(this,Ft,qo)}
            @datetime:updated=${s=>So(s,this)}
            @layerConfig:change=${I(this,Ft,Zo)}
          ></eox-layercontrol-layer-list>
        `)}
