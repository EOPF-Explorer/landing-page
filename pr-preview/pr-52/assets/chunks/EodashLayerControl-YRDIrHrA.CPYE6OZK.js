const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/main.DbeRvNcr.js","assets/chunks/addCommonStyleSheet.B-YfsHf1.js","assets/chunks/when.BR7zwNJC.js","assets/chunks/repeat.C25DloxU.js","assets/chunks/directive.CvdRHFdJ.js","assets/chunks/directive-helpers.GScZEY_D.js","assets/chunks/unsafe-html.B6CMt-DA.js","assets/chunks/map.DiiNQ3pp.js","assets/chunks/commonjsHelpers.BosuxZz1.js","assets/chunks/index.BUIxO2d3.js","assets/chunks/getElement.CdRlZPdn.js","assets/chunks/main.2eYAyxwS.js","assets/chunks/browser.CvBADTdS.js","assets/chunks/toolcool-range-slider.min.BBXDELo7.js","assets/chunks/utils.CdF70kIP.js","assets/chunks/index.2GfG_t-c.js","assets/chunks/index.BIJR-IiI.js"])))=>i.map(i=>d[i]);
var it=Object.defineProperty;var st=(n,t,e)=>t in n?it(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var w=(n,t,e)=>st(n,typeof t!="symbol"?t+"":t,e);import{aL as V,c as A,o as j,e as B,h as nt,K as rt,p as at,k as F,r as ot,j as P,t as lt,a5 as N}from"./framework.87C1dpA8.js";import{f as ct,u as ht,E as dt,b as C,w as _,c as ut,i as pt}from"./addCommonStyleSheet.B-YfsHf1.js";import{a6 as ft,a1 as D,E as q,ab as mt,ac as gt,ad as yt,O as bt,h as vt}from"./sequential.BcvVcPN9.js";import{e as kt,i as wt,t as xt}from"./directive.CvdRHFdJ.js";import"./main.DTMXrDzy.js";import{_ as _t,s as Tt,a as Ct,g as Et,f as St,am as z,an as U,at as At,au as jt,av as Ft}from"./eo-dash.CSqJZF23.js";import"./dayjs.min.Ba62AOpW.js";import"./commonjsHelpers.BosuxZz1.js";import"./when.BR7zwNJC.js";import"./map.DiiNQ3pp.js";import"./toolcool-range-slider.min.BBXDELo7.js";import"./getElement.CdRlZPdn.js";import"./index.BIJR-IiI.js";import"./item.Bx-rtsOD.js";import"./mdi.CdEehoCo.js";/**
 * @license
 ...
 */const L=kt(class extends wt{constructor(n){var t;if(super(n),n.type!==xt.ATTRIBUTE||n.name!=="class"||((t=n.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(n){return" "+Object.keys(n).filter(t=>n[t]).join(" ")+" "}update(n,[t]){var i,r;if(this.st===void 0){this.st=new Set,n.strings!==void 0&&(this.nt=new Set(n.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in t)t[s]&&!((i=this.nt)!=null&&i.has(s))&&this.st.add(s);return this.render(t)}const e=n.element.classList;for(const s of this.st)s in t||(e.remove(s),this.st.delete(s));for(const s in t){const a=!!t[s];a===this.st.has(s)||(r=this.nt)!=null&&r.has(s)||(a?(e.add(s),this.st.add(s)):(e.remove(s),this.st.delete(s)))}return dt}});class Vt{constructor(t){this.cle=t}render(){const t=this.cle.titleText?C`<p class="legend-title">${this.cle.titleText}</p>`:"",e={hidden:this.cle.scaleType==="categorical"},i={hidden:this.cle.scaleType!=="categorical","categorical-container":!0};return C`<div
    ...
    >
      ...
      <slot name="footer"></slot>
        ...
        >
          ${s}
        </li>`)}`}renderContinuous(){var d;if(this.cle.scaleType!=="continuous"||this.cle.colorScale===null)return"";const{colorScale:t,marginTop:e,marginLeft:i,marginRight:r,tickSize:s,width:a,range:o}=this.cle,c=this.cle.marginBottom+s,h=this.cle.height+s,l=((d=t.interpolator)==null?void 0:d.call(t))||bt(q,o);return _`<image
      x=${i}
      y=${e}
      width=${a-r-i}
      height=${h-e-c}
    ...
    ></image>`}renderDiscreteThreshold(){if(this.cle.scaleType!=="discrete"&&this.cle.scaleType!=="threshold")return"";const{tickSize:t,marginTop:e,marginLeft:i,colorScale:r,xScale:s}=this.cle,a=this.cle.height+t,o=this.cle.marginBottom+t,c=r.range(),h=d=>r.invertExtent(d).map(s)[0]||i,l=d=>{let[f,g]=r.invertExtent(d).map(s);return f=f||0,g=g||s.range()[1],g-f};return _`${c.map(d=>_`<rect x=${h(d)} y=${e} width=${l(d)} height=${a-e-o} fill=${d}></rect>`)}`}renderAxis(){if(!this.cle.xScale||this.cle.scaleType==="categorical")return"";const{ticks:t,tickSize:e,tickFormat:i,tickFormatter:r,tickValues:s,xScale:a,marginTop:o}=this.cle,c=this.cle.height+e,h=this.cle.marginBottom+e,l=s!=null&&s.length?s:a.ticks.apply(a,[t,i]),d=Math.max(e,0)+3,f=()=>l.map(g=>_`<g class="tick" transform='translate(${a(g)},0)'>
