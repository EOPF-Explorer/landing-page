import"./main.B_5CY3O5.js";import{o as v}from"./handling-Bc0oyRZ9.BLKWysVD.js";import{_ as B,g as O,a as s,c as z,b as M,d as R,e as T}from"./eo-dash.CGP4fRNq.js";import{a as I,b as N}from"./mdi.C-iBXNyW.js";import{T as D}from"./index-BHCtsD00.BYvIGUW3.js";import{q as V,a4 as q,v as L,Y as A,o as l,c as p,j as g,a2 as J,k as f,e as x,N as y,ao as b,p as w,h as i,P}from"./framework.W58BR3_i.js";import"./lit-element.CBn2YVps.js";import"./addCommonStyleSheet.BL0mKR1r.js";import"./sequential.BdGG0OD6.js";import"./orient2d.DArCjZZA.js";import"./async-CwQwKJhy.BjIzv8vK.js";import"./utils.BJtOAKhC.js";import"./index.CxojoGlr.js";import"./migrate.DkSLOl0d.js";import"./commonjsHelpers.BosuxZz1.js";import"./main.BHf_YhEi.js";import"./when.BR7zwNJC.js";import"./map.B6QQHL2e.js";import"./XYZ.BZLCURoo.js";import"./proj.DtkH-SLQ.js";import"./index.BUIxO2d3.js";import"./getElement.COiK8z0h.js";import"./VTooltip-CJpaHPhm.BqAmEapf.js";import"./forwardRefs-Kl3OtrB6.CTSgYcUI.js";import"./transition-M1WmWTSn.BLgUeisG.js";const j=".bg-surface:has(.eodash-chart-wrapper){height:100%;display:flex;flex-direction:column}",F=".eodash-chart-wrapper[data-v-29f0a1a6]{height:100%;flex-grow:1;min-height:180px;display:flex;flex-direction:column}.chart-frame[data-v-29f0a1a6]{position:relative;flex-grow:1;min-height:180px;display:flex;flex-direction:column}eox-chart[data-v-29f0a1a6]{flex-grow:1;min-height:0}.chart-toggle[data-v-29f0a1a6]{position:absolute;top:8px;right:46px;z-index:2;cursor:pointer}",H={ref:"container",class:"eodash-chart-wrapper"},K={viewBox:"0 0 20 20",width:"20",height:"20","aria-hidden":"true"},U=["d"],Y=[".spec",".dataValues",".opt"],G={__name:"EodashChart",props:{enableCompare:{type:Boolean,default:!1},vegaEmbedOptions:{type:Object,default(){return{actions:!0}}}},setup(c){const d=i(()=>c.enableCompare?z.value:M.value),m=i(()=>c.enableCompare?R.value:T.value),C=i(()=>{const a=m.value;if(!a)return!1;let t=!1;const o=e=>{if(!(t||!e||typeof e!="object")){if("bind"in e&&typeof e.bind=="object"&&e.bind!==null&&"input"in e.bind){t=!0;return}Object.values(e).forEach(o)}};return o(a),t}),n=w(null);V(m,a=>{if(!a){n.value=null;return}const t=JSON.parse(JSON.stringify(a));t.height="container",t.width="container",P(()=>{n.value=t,u.value=Math.random(),setTimeout(()=>{window.dispatchEvent(new Event("resize"))},150)})},{immediate:!0});const u=w(0),_=q("container");let r=null,h=null;L(()=>{const a=_.value;if(!a)return;h=window.setInterval(()=>{if(a){const o=a.querySelector("eox-chart");if(o&&o.shadowRoot&&!o.shadowRoot.querySelector("#eodash-chart-styles")){const e=document.createElement("style");e.id="eodash-chart-styles",e.innerHTML=`
            * {
